...
func Routers() *gin.Engine {
	Router := gin.Default()
	ReqOrderRouter := router.RouterGroupApp.Reqorder
	// reqOrderRouter := router.RouterGroupApp.Reqorder
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		orderRouter.InitSubOrderRouter(PrivateGroup)
		companyRouter.InitCompanyDiscountRouter(PrivateGroup)
		orderRouter.InitUploadSubOrderRouter(PrivateGroup)
		ReqOrderRouter.InitRequireOrderRouter(PrivateGroup)
		ReqOrderRouter.InitReqSubOrderRouter(PrivateGroup)
