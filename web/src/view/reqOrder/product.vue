  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="SELFLIFE" width="100">
          <template #default="scope">{{ scope.row.self_life }}</template>
        </el-table-column>
        <el-table-column align="left" label="BARCODE" width="100">
          <template #default="scope">{{ scope.row.barcode }}</template>
        </el-table-column>
        <el-table-column align="left" label="BARCODE(CASE)" width="140">
          <template #default="scope">{{ scope.row.barcode_case }}</template>
        </el-table-column>
        <el-table-column align="left" label="CARTON SIZE" width="140">
          <template #default="scope">{{ scope.row.carton_size }}</template>
        </el-table-column>
        <el-table-column align="left" label="CBM" width="100">
          <template #default="scope">{{ scope.row.cbm }}</template>
        </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="采购信息">
      <el-form ref="elFormRef" :model="formData" label-position="right" :rules="rule" label-width="140px">
        <el-form-item label="商品编号:" prop="code">
          <el-input v-model="formData.code" :clearable="false" readonly />
        </el-form-item>
        <el-form-item label="商品中文名:" prop="product_name_cn">
          <el-input v-model="formData.product_name_cn" :clearable="true" readonly />
        </el-form-item>
        <el-form-item label="商品英文名:" prop="product_name_en">
          <el-input v-model="formData.product_name_en" :clearable="true" readonly />
        </el-form-item>
        <el-form-item label="Self Life:" prop="selflife">
          <el-input v-model="formData.self_life" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="Barcode:" prop="barcode">
          <el-input v-model="formData.barcode" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="Barcode(CASE):" prop="barcode_case">
          <el-input v-model="formData.barcode_case" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="Carton Size:" prop="carton_size">
          <el-input v-model="formData.carton_size" style="width:100%" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="CBM:" prop="cbm">
          <el-input-number v-model.number="formData.cbm" style="width:100%" :precision="4" :clearable="true" />
        </el-form-item>
